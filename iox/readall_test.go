...
func ExampleReadAll_Reader() {
	...
	//Output:
	//test: ReadAll(file://[cwd]/ioxtest/address3.jsonx) -> [type:*strings.Reader] [buf:72] [status:<nil>]
	//test: ReadAll(file://[cwd]/ioxtest/address3.jsonx) -> [type:io.nopCloserWriterTo] [buf:72] [status:<nil>]
